...
public class LanguageGamesLevel2 : MonoBehaviour
{
    ...
    public GameObject panelQuizText; // Referensi ke UI Panel yang akan ditampilkan
    ...
    public void ShowPanelQuiz()
    {
        panelMatchQuiz.SetActive(true);
        panelQuizText.SetActive(true);
    }
}
